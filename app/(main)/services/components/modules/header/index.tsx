	...
	return (
		<header className='relative flex min-h-screen flex-col items-center' style={{ clipPath: 'inset(0)' }}>
			<div className='wrapper'>
				<Parallax isAbsolutelyPositioned lerpEase={0.15} strength={0.25}>
					<div className='flex flex-col items-center gap-4 pt-36 text-center md:pt-48'>
						<h1 className='text-gradient relative z-10 max-w-md px-4 font-heading text-xl font-bold uppercase md:px-8 md:text-2xl xl:text-3xl'>
				...
				<Image
					...
					draggable={false}
					priority
					className='fixed bottom-0 left-1/2 z-0 aspect-[360/893] h-auto max-w-full -translate-x-1/2 translate-y-1/4 opacity-75'
				/>
			</div>
		</header>
	)
