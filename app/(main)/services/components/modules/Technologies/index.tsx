...
const Technologies = (props: Props) => {
	return (
		<section className='wrapper flex flex-col items-center pb-24 text-center'>
			<SectionHeading label='our skills'>Skills & Tools</SectionHeading>
			...
			<div className='mt-12 flex flex-wrap justify-center gap-4'>
				{Array(20)
					...
					.map((_, index) => (
						<div
							key={index}
							className='flex h-24 w-24 flex-col gap-2 rounded-lg border border-dark-700/20 bg-dark-800/20 p-2'>
							<svg
								className='w-full'
								fill='#ffffffde'
								height='1024pt'
							...
							<h3 className='font-bold text-neutral-300'>Next.js</h3>
						</div>
					))}
			</div>
		</section>
